...
<body>
    ...
    <img src="img/logo.png">
        ...
        <section><h1> Mirror Fashion  </h1></section>

            
    <section><p> A <strong>Mirror Fashion</strong> é a maior empresa comércio eletrônico no segmento de moda em todo o mundo.
        Fundada há <?php print date("Y") - 1932 ; ?> anos, possui filiais em 124 países, sendo líder de mercado com mais de 90% de
        participação em 118 deles.</p>
        <iframe width="853" height="480" src="https://www.youtube.com/embed/2ht-0EMvrcE" frameborder="0"
        ...
        <figure id="familia-pelho">
            ...
            <em>Família Pelho</em></figcaption>
        </figure>
